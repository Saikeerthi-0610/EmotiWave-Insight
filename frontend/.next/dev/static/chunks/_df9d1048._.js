...
function AuthForm() {
    ...
    if ($[0] !== "ad718ca509fcc5b112c1571cbbf14f3fff621b17ea2f97903573f3408464d1c6") {
        for(let $i = 0; $i < 123; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "ad718ca509fcc5b112c1571cbbf14f3fff621b17ea2f97903573f3408464d1c6";
    }
    ...
    if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = ({
            "AuthForm[handleInputChange]": (field, value)=>{
                setFormData({
                    "AuthForm[handleInputChange > setFormData()]": (prev)=>({
                            ...prev,
                            [field]: value
                        })
                }["AuthForm[handleInputChange > setFormData()]"]);
            }
        })["AuthForm[handleInputChange]"];
        $[2] = t1;
    } else {
        t1 = $[2];
    }
    ...
    let t2;
    if ($[3] !== formData.designation || $[4] !== formData.name || $[5] !== formData.patientId || $[6] !== formData.phone || $[7] !== mode || $[8] !== role) {
        t2 = ({
            "AuthForm[handleRequestOTP]": async ()=>{
                if (mode === "login") {
                ...
                setIsLoading(true);
                setTimeout({
                    "AuthForm[handleRequestOTP > setTimeout()]": ()=>{
                        setOtpSent(true);
                        setIsLoading(false);
                        const userData = {
                        ...
                        setTimeout({
                            "AuthForm[handleRequestOTP > setTimeout() > setTimeout()]": ()=>{
                                if (role === "admin") {
                        ...
                        }["AuthForm[handleRequestOTP > setTimeout() > setTimeout()]"], 1000);
                        alert(`OTP verified! Logging in as ${role}...`);
                    }
                }["AuthForm[handleRequestOTP > setTimeout()]"], 1500);
            }
        })["AuthForm[handleRequestOTP]"];
        $[3] = formData.designation;
        $[4] = formData.name;
        $[5] = formData.patientId;
        $[6] = formData.phone;
        $[7] = mode;
        $[8] = role;
        $[9] = t2;
    ...
    const handleRequestOTP = t2;
    let t3;
    if ($[10] !== formData.designation || $[11] !== formData.name || $[12] !== formData.patientId || $[13] !== formData.phone || $[14] !== mode || $[15] !== role) {
        t3 = ({
            "AuthForm[isFormValid]": ()=>{
                if (mode === "login") {
        ...
        $[10] = formData.designation;
        $[11] = formData.name;
        $[12] = formData.patientId;
        $[13] = formData.phone;
        $[14] = mode;
        $[15] = role;
        $[16] = t3;
    ...
    const t16 = `toggle-btn z-10 transition-colors ${mode === "login" ? "text-[#3B6F8E] font-semibold" : ""}`;
    let t17;
    ...
    const t19 = `toggle-btn z-10 transition-colors ${mode === "register" ? "text-[#3B6F8E] font-semibold" : ""}`;
    let t20;
    ...
    const t24 = role === "patient" ? "0%" : role === "doctor" ? "33.33%" : "66.66%";
    let t25;
    if ($[41] !== t24) {
        t25 = {
            left: t24
    ...
    const t28 = `toggle-btn z-10 transition-colors ${role === "patient" ? "text-[#3B6F8E] font-semibold" : ""}`;
    let t29;
    let t30;
    ...
    const t32 = `toggle-btn z-10 transition-colors ${role === "doctor" ? "text-[#3B6F8E] font-semibold" : ""}`;
    let t33;
    let t34;
    ...
    const t36 = `toggle-btn z-10 transition-colors ${role === "admin" ? "text-[#3B6F8E] font-semibold" : ""}`;
    let t37;
    let t38;
    ...
    let t40;
    if ($[58] !== t27 || $[59] !== t31 || $[60] !== t35 || $[61] !== t39) {
    ...
    let t46;
    if ($[67] !== formData.designation || $[68] !== formData.name || $[69] !== mode || $[70] !== role) {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                        ...
                        value: formData.name,
                        onChange: {
                            "AuthForm[<input>.onChange]": (e)=>handleInputChange("name", e.target.value)
                ...
                role === "doctor" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                        ...
                        onChange: {
                            "AuthForm[<input>.onChange]": (e_0)=>handleInputChange("designation", e_0.target.value)
                        }["AuthForm[<input>.onChange]"]
                    }, void 0, false, {
                        fileName: "[project]/src/components/AuthForm.tsx",
                        lineNumber: 474,
    ...
    let t47;
    if ($[72] !== formData.patientId || $[73] !== mode) {
        t47 = mode === "login" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
            className: "relative",
            initial: {
                opacity: 0,
                x: -20
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                ...
                onChange: {
                    "AuthForm[<input>.onChange]": (e_1)=>handleInputChange("patientId", e_1.target.value)
                }["AuthForm[<input>.onChange]"]
            }, void 0, false, {
                fileName: "[project]/src/components/AuthForm.tsx",
                lineNumber: 495,
    ...
    const t50 = mode === "register" && role === "doctor" ? 0.3 : 0.2;
    let t51;
    if ($[77] !== t50) {
        t51 = {
            delay: t50
    ...
    if ($[79] === Symbol.for("react.memo_cache_sentinel")) {
        t52 = ({
            "AuthForm[<input>.onChange]": (e_2)=>handleInputChange("phone", e_2.target.value)
        })["AuthForm[<input>.onChange]"];
        $[79] = t52;
    } else {
        t52 = $[79];
    ...
    let t55;
    if ($[85] !== formData.email || $[86] !== mode || $[87] !== role) {
        t55 = mode === "register" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
            className: "relative",
            initial: {
                opacity: 0,
                x: -20
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                ...
                onChange: {
                    "AuthForm[<input>.onChange]": (e_3)=>handleInputChange("email", e_3.target.value)
                }["AuthForm[<input>.onChange]"]
            }, void 0, false, {
                fileName: "[project]/src/components/AuthForm.tsx",
                lineNumber: 568,
    ...
    let t56;
    if ($[89] !== t41 || $[90] !== t46 || $[91] !== t47 || $[92] !== t54 || $[93] !== t55) {
    ...
    let t57;
    if ($[95] !== formData.email || $[96] !== otpSent) {
        t57 = otpSent && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
            initial: {
                opacity: 0,
                y: -10
            },
    ...
    const t62 = `w-full mt-6 flex items-center justify-center gap-2 group py-3 rounded-xl font-semibold transition-all ${isFormValid() ? "bg-[#56B79A] hover:bg-[#4da88d] text-white cursor-pointer" : "bg-gray-300 text-gray-500 cursor-not-allowed"}`;
    let t63;
    if ($[102] !== isFormValid || $[103] !== isLoading) {
        t63 = !isFormValid() || isLoading;
        $[102] = isFormValid;
        $[103] = isLoading;
        $[104] = t63;
    } else {
    ...
    let t64;
    if ($[105] !== isFormValid || $[106] !== isLoading || $[107] !== mode) {
        t64 = isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
            children: [
    ...
    let t65;
    if ($[109] !== handleRequestOTP || $[110] !== t59 || $[111] !== t61 || $[112] !== t62 || $[113] !== t63 || $[114] !== t64) {
    ...
    let t67;
    if ($[117] !== t22 || $[118] !== t40 || $[119] !== t56 || $[120] !== t57 || $[121] !== t65) {
...
_s(AuthForm, "F4+96ER/zSNe/FUBT0AazlsznGY=");
_c = AuthForm;
var _c;
