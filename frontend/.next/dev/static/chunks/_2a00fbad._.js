...
function MonitorPage() {
    ...
    if ($[0] !== "c4547d59641ac90b1fcd2a39319039905ce61be1277ec40f366f0bd9259e0a77") {
        for(let $i = 0; $i < 37; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "c4547d59641ac90b1fcd2a39319039905ce61be1277ec40f366f0bd9259e0a77";
    }
                    ...
                    complete: (results)=>{
                        ...
                        const stats = persons.map({
                            "MonitorPage[handleFileUpload > <anonymous> > persons.map()]": (p)=>{
                                ...
                                const avg = {
                                    "MonitorPage[handleFileUpload > <anonymous> > persons.map() > avg]": (key)=>(userData_0.reduce({
                                            "MonitorPage[handleFileUpload > <anonymous> > persons.map() > avg > userData_0.reduce()]": (s, d)=>s + d[key]
                                        }["MonitorPage[handleFileUpload > <anonymous> > persons.map() > avg > userData_0.reduce()]"], 0) / userData_0.length).toFixed(2)
                        ...
                        stats.forEach({
                            "MonitorPage[handleFileUpload > <anonymous> > stats.forEach()]": (personStat)=>{
                                ...
                                const dominantWave = Object.entries(waves).reduce({
                                    "MonitorPage[handleFileUpload > <anonymous> > stats.forEach() > (anonymous)()]": (a, b)=>waves[a[0]] > waves[b[0]] ? a : b
                                }["MonitorPage[handleFileUpload > <anonymous> > stats.forEach() > (anonymous)()]"])[0];
                                ...
                                const newReport = {
                                    ...
                                    accuracy: "98.59%",
                                    dataPoints: rows.filter({
                                        "MonitorPage[handleFileUpload > <anonymous> > stats.forEach() > rows.filter()]": (r_2)=>r_2.person === personStat.person
                                    }["MonitorPage[handleFileUpload > <anonymous> > stats.forEach() > rows.filter()]"]).length,
                                    frequencies: {
                                        alpha: personStat.alpha,
                                        beta: personStat.beta,
                                        gamma: personStat.gamma,
                                    ...
                                    notes: `Patient shows ${emotion.toLowerCase()} emotional state with ${dominantWaveCapitalized.toLowerCase()} wave dominance. ${emotion === "Positive" ? "Good emotional regulation observed." : emotion === "Negative" ? "Elevated stress indicators detected." : "Balanced emotional baseline."}`,
                                    duration: "5 minutes"
                                };
                                existingReports.push(newReport);
                            }
                        }["MonitorPage[handleFileUpload > <anonymous> > stats.forEach()]"]);
                        localStorage.setItem("patientReports", JSON.stringify(existingReports));
                        setTimeout({
                            "MonitorPage[handleFileUpload > <anonymous> > setTimeout()]": ()=>{
                                router.push("/analysis");
                            }
                        }["MonitorPage[handleFileUpload > <anonymous> > setTimeout()]"], 1000);
                    }
                });
            }
    ...
    let t20;
    if ($[25] !== dragActive || $[26] !== fileName || $[27] !== handleFileUpload || $[28] !== isUploading) {
        t20 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: isUploading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                        className: `w-32 h-32 bg-gradient-to-br from-[#3B6F8E] to-[#56B79A] rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-xl transition-all ${dragActive ? "scale-110 shadow-2xl" : ""}`,
                        whileHover: {
                            scale: 1.05,
                            rotate: 5
                        },
...
_s(MonitorPage, "8SbVLK+r/Qbx/Eg8AzSzR8GPDvQ=", false, function() {
    return [
...
function _MonitorPageAnonymous(step, i) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
...
//# sourceMappingURL=_2a00fbad._.js.map