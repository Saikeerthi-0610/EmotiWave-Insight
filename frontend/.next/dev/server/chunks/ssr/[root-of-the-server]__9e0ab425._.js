        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$papaparse$2f$papaparse$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].parse(file, {
            ...
            complete: (results)=>{
                ...
                stats.forEach((personStat)=>{
                    ...
                    const dominantWave = Object.entries(waves).reduce((a, b)=>waves[a[0]] > waves[b[0]] ? a : b)[0];
                    ...
                    const newReport = {
                        ...
                        accuracy: "98.59%",
                        dataPoints: rows.filter((r)=>r.person === personStat.person).length,
                        frequencies: {
                            alpha: personStat.alpha,
                            beta: personStat.beta,
                            gamma: personStat.gamma,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9e0ab425._.js.map